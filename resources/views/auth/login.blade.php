              ...
              <div class="app-brand justify-content-center">
                <a href="" class="app-brand-link gap-2">
                  <span class="app-brand-logo demo">
                    <img src="{{ asset('assets/img/logo/logo.png') }}" alt="Spin Wheel Logo" style="max-height: 150px;">
                  </span>
                </a>
              </div>
              <!-- /Logo -->
              <h4 class="mb-2">Sign In 👋</h4>
              <p class="mb-4">Welcome back to your account.</p>

              <form method="POST" action="{{ route('login') }}" id="" class="mb-3">
                @csrf
                <div class="mb-3">
